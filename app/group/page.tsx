  ...
  async function handleJoin() {
    ...
    try {
      ...
      if (!session || session.mode !== "group") {
        setError("That code doesn't match a Group Roleplay game.");
        return;
      }
      ...
      <main className="bg-grid-blue flex flex-1 flex-col px-4 py-8 sm:py-10">
        ...
        <div className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center">
          ...
          <StickerCard className="rounded-t-none p-5 text-center sm:p-6">
            <h1 className="font-display text-3xl leading-tight sm:text-4xl text-brand-red mb-4">
              Group roleplay
            </h1>
            ...
            <p className="mt-5 text-left text-sm font-medium sm:text-base">
        ...
        <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
          ...
          <StickerCard className="rounded-t-none p-6 sm:p-8 text-center">
            ...
            <p className="mb-8 text-sm sm:text-base">
              You can create an invitation code to send to your group.
            </p>
            {error && (
    ...
    <main className="bg-grid-blue flex flex-1 flex-col px-4 py-8 sm:py-10">
      ...
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center pb-10">
        ...
        <StickerCard className="rounded-t-none p-6 sm:p-8 text-center">
          ...
          <p className="mb-6 text-sm sm:text-base">
            You can get an invitation code from your group.
          </p>
          <div className="mb-6">
